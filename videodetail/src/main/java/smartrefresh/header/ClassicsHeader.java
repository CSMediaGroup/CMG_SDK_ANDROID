...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs) {
        ...
        View.inflate(context, R.layout.cmg_srl_classics_header, this);
...
//            mLastUpdateText.setTextSize(12);
        ...
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextPulling)){
            ...
            mTextPulling = context.getString(R.string.cmg_srl_header_pulling);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextLoading)){
            ...
            mTextLoading = context.getString(R.string.cmg_srl_header_loading);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextRelease)){
            ...
            mTextRelease = context.getString(R.string.cmg_srl_header_release);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextFinish)){
            ...
            mTextFinish = context.getString(R.string.cmg_srl_header_finish);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextFailed)){
            ...
            mTextFailed = context.getString(R.string.cmg_srl_header_failed);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextSecondary)){
            ...
            mTextSecondary = context.getString(R.string.cmg_srl_header_secondary);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextRefreshing)){
            ...
            mTextRefreshing = context.getString(R.string.cmg_srl_header_refreshing);
        }
        if(ta.hasValue(R.styleable.ClassicsHeader_srlTextUpdate)){
            ...
            mTextUpdate = context.getString(R.string.cmg_srl_header_update);
        }
